...
7. The network names used in the Dockerfile are problematic because I am using that value in nginx.conf. So if you change the name for the app store, you have to update the network names as well as the nginx conf.
